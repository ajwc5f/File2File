...
export default {
  ...
  methods: {
    setAccessToken () {
    	this.$store.commit('setAccessToken', this.dropbox_access_token);
    },
  ...
  mounted: function () {
    ...
    if (vm.isAuthenticated()) {
      ...
      .then(function(response) {
        ...
        vm.$emit('dropboxAuthenticated', vm.dropbox_access_token);
      ...
      var authUrl = dbx.getAuthenticationUrl('http://localhost:8080/dropboxauth');
